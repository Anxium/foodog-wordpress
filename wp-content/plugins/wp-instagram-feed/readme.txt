...
Instagram Feed Display beautifully clean, customizable, and responsive feeds from Instagram accounts. Instagram feed plugin helps you to display Instagram photos from any private or non-private (public) Instagram account, in same way you can also show instagrm photo feed from any hastag and disply instagram feed into your posts, pages, home or in widget. With instagram feed plugin you can add multiple instagram feeds into single page, post or widget using shortcodes.
...
A. Display statuses, photos, links from your Instagram Account. Display multiple feeds from different Instagram Accounts.
...
* Fixed Hashtag Issue, where users weren't able to get feeds using hashtags
